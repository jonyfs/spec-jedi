...
كل skill تتحقق من مخرجاتها الخاصة مقابل الدستور — وليس العكس. غيّر
القواعد، وستشعر كل skill في المصب بذلك في تشغيلها التالي.
...
| `specjedi-diagram` 📊 | تُنشئ مخطط Mermaid مُتحقَّقاً من عرضه — النوع الصحيح مُختاراً من كتالوج Mermaid الكامل (انسيابي، تسلسلي، ER، فئات، حالة، Gantt، جدول زمني، رحلة المستخدم، kanban، خريطة ذهنية، رباعي، دائري، والمزيد) — من `spec.md`/`plan.md` موجود — دائماً مكمِّل للنص المصدر، وليس بديلاً عنه أبداً |
...
14. تريد صورة بدلاً من جدار نصي؟ تحوّل `specjedi-diagram` 📊 مواصفة أو
    خطة إلى مخطط Mermaid مُتحقَّق من عرضه — باختيار النوع من الكتالوج
    الكامل (انظر
