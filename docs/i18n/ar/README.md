<!-- i18n-sync: source=README.md@e0a1fb8 lang=ar -->
...
النهاية. اليوم، تم بناء مسارين واختبارهما وتوثيقهما بالكامل: Claude Code
(انظر الخطوات أعلاه) و Codex CLI (`./scripts/install.sh --harness
codex-cli` / `.\scripts\install.ps1 -Harness codex-cli`، مع التثبيت في
`.agents/skills/` — تم التحقق منه مقابل اتفاقية اكتشاف المهارات الموثقة
الخاصة بـ Codex CLI نفسه).
