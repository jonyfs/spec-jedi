<!-- i18n-sync: source=README.md@01f83f5 lang=bn -->
...
| `specjedi-diagram` 📊 | একটি বিদ্যমান `spec.md`/`plan.md` থেকে রেন্ডার-ভেরিফায়েড Mermaid ডায়াগ্রাম তৈরি করে (ফ্লোচার্ট, সিকোয়েন্স, বা ER — বিষয়বস্তু থেকে অনুমিত) — সবসময় মূল প্রোজের পরিপূরক, কখনো প্রতিস্থাপন নয় |
...
14. প্রোজের দেয়ালের বদলে একটি ছবি চান? `specjedi-diagram` 📊 একটি স্পেক
    ...
    করে — ফ্লোচার্ট, সিকোয়েন্স, বা ER, প্রকৃত বিষয়বস্তু যা দাবি করে —
    সবসময় মূল প্রোজের পাশে, কখনো তার জায়গায় নয়।
