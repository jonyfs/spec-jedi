<!-- i18n-sync: source=README.md@e0a1fb8 lang=bn -->
...
টুল/হার্নেস সমর্থন করতে প্রতিশ্রুতিবদ্ধ করে। আজ, দুটি পথ সম্পূর্ণভাবে
তৈরি, পরীক্ষিত এবং ডকুমেন্টেড হয়েছে: Claude Code (উপরের ধাপ দেখুন) এবং
Codex CLI (`./scripts/install.sh --harness codex-cli` /
`.\scripts\install.ps1 -Harness codex-cli`, `.agents/skills/`-এ ইনস্টল
হয় — Codex CLI-এর নিজস্ব ডকুমেন্টেড স্কিল-ডিসকভারি কনভেনশনের বিপরীতে
যাচাই করা হয়েছে)।
