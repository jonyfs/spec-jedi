<!-- i18n-sync: source=README.md@1609524 lang=bn -->
...
[![Skills](https://img.shields.io/badge/specjedi_skills-25_shipped-success)](#spec-jedi-কীভাবে-sdd-বাস্তবায়ন-করে)
...
থাকার আগে, কী তৈরি করা হচ্ছে এবং কেন তা লিখে রাখা হয়, একটি কাঠামোগত,
পর্যালোচনাযোগ্য নথি হিসেবে — একটি **constitution** 📜 (অলঙ্ঘনীয় নিয়ম),
একটি **specification** 🎯 (কী, এবং কার জন্য), একটি **plan** 🛠️ (কীভাবে,
প্রযুক্তিগতভাবে), এবং একটি **task list** ✅ (ক্রমানুসারে ধাপগুলো)। কোড এই
আর্টিফ্যাক্টগুলোর *ভিত্তিতে* তৈরি হয়, উল্টো নয় — সেই একই শৃঙ্খলা যা Jedi
Code প্রশিক্ষণের বিরক্তিকর অংশ এড়িয়ে যেতে প্রলুব্ধ যে কারো কাছ থেকে দাবি
করে। সম্পূর্ণ ব্যাখ্যা, Spec Jedi-এর নিজস্ব কোনো ব্র্যান্ডিং ছাড়াই:
...
([Principle XV](../../../.specify/memory/constitution.md)) — বিশটি কোডিং
এজেন্ট সত্যিকারভাবে সমর্থিত, শুধু তত্ত্বে নয় (নিচে
...
ফিচার ব্রাঞ্চ এবং pull request-এর মাধ্যমে। আজ মোট পঁচিশটি skill উপলব্ধ,
...
> মূল্যায়ন করছেন, নিচের [ইনস্টলেশন](#ইনস্টলেশন)-এ সরাসরি যান** — প্রকৃত
...
প্রথম যুদ্ধ কখনো শেষটি নয়। `/speckit-constitution` নিয়মগুলো একবার লেখে,
...
আসলে কী তৈরি হচ্ছে, এবং কার জন্য। `/speckit-specify` এটিকে একটি প্রকৃত
`spec.md`-এ রূপান্তর করে; `/speckit-clarify` অস্পষ্টতাকে ধরতে বের হয়, এটি
...
তারপর ব্লুপ্রিন্ট বেরিয়ে আসে। `/speckit-plan` হয়ে যায় `plan.md`,
`/speckit-tasks` এটিকে একটি ক্রমানুসারে, ডিপেন্ডেন্সি-সচেতন `tasks.md`-এ
...
এবং তারপর, ধীরে ধীরে, ব্যর্থ হওয়া বন্ধ করে। `/speckit-implement` যেখানে
...
ডায়াগ্রামগুলো দেখানোর আগে রেন্ডারিং দিয়ে যাচাই করা হয়, এবং constitution
একটি জীবন্ত, ভার্সনযুক্ত নথি v1.24.0-এ, একটি নথিভুক্ত সংশোধনী ইতিহাসসহ।
অন্য অর্ধেকটি, স্পষ্টভাবে বলতে গেলে: এখনও পর্যন্ত কোনো রিলিজ কাটা হয়নি
(এটি লেখার সময় `git tag -l` কিছুই ফেরত দেয় না), এবং বেশিরভাগ bridge-file
হার্নেস ইনস্টল পথ প্রকৃত তৃতীয়-পক্ষের প্রোডাক্টের ভেতরে হাতে-কলমে
পরীক্ষার বদলে ডেস্ক রিসার্চের উপর ভিত্তি করে। সম্পূর্ণ, ফিল্টারহীন চিত্র:
