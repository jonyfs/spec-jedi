...
সাথে থাকুক। 🌌 "Lightsaber" আইকনটি Carlos von Dessauer-এর তৈরি,
[Noun Project](https://thenounproject.com) থেকে, CC BY 3.0-এর অধীনে
ব্যবহৃত।)*
...
প্রতিটি skill নিজের output-কে constitution-এর বিপরীতে verify করে —
উল্টোটা নয়। নিয়ম বদলালে, নিচের প্রতিটি skill তার পরবর্তী run-এ তা
অনুভব করে।
...
> *"একজন Jedi-র শক্তি আসে Force থেকে। একটি প্রজেক্টেরও, একইভাবে, আসে
> তার skills থেকে।"* — একজন জ্ঞানী Master, সম্ভবত।

তেইশ সংখ্যায়, এই Order — যুদ্ধের জন্য নয়, বরং Spec-Driven Development-এর
জন্য প্রশিক্ষিত। চারটি শৃঙ্খলা এটি বজায় রাখে:
...
`--harness` এখন ঐচ্ছিক — যদি বাদ দেওয়া হয়, ইনস্টলার আপনি কোন কোডিং
এজেন্ট ব্যবহার করছেন তা শনাক্ত করার চেষ্টা করে (আগে থেকেই বিদ্যমান
প্রজেক্ট ডিরেক্টরি, `PATH`-এ থাকা বাইনারি, অথবা আগে থেকেই বিদ্যমান
গ্লোবাল কনফিগ ডিরেক্টরি) এবং স্বয়ংক্রিয়ভাবে তার জন্য ইনস্টল করে —
শুধুমাত্র একাধিক সম্ভাব্য মিল পাওয়া গেলেই জিজ্ঞাসা করে। `claude-code`,
`codex-cli`, এবং `trae` আজ তৈরি এবং পরীক্ষিত; অন্য যেকোনো স্পষ্ট মান
নীরবে চেষ্টা করার বদলে এখনো-সমর্থিত-নয় হিসেবে রিপোর্ট করা হয় — নিচে
[সমর্থিত হার্নেস](#সমর্থিত-হার্নেস) দেখুন। সম্পূর্ণ অপশন তালিকার জন্য
`./scripts/install.sh --help` (বা `.\scripts\install.ps1 -Help`)
চালান, যাতে `--auto`-ও অন্তর্ভুক্ত।
...
টুল/হার্নেস সমর্থন করতে প্রতিশ্রুতিবদ্ধ করে। আজ, পাঁচটি হার্নেস আসল,
পরীক্ষিত, এবং CI-প্রমাণিত — তিনটি একটি ডেডিকেটেড ইনস্টলার ব্র্যাঞ্চের
মাধ্যমে (Claude Code, Codex CLI, Trae), এবং আরও দুটি (OpenCode, Warp)
কোনো অতিরিক্ত কোড ছাড়াই সেই একই ইনস্টল পাথ দ্বারা সন্তুষ্ট হয়, কারণ
উভয়েই ইনস্টলার ইতিমধ্যে যে সঠিক ডিরেক্টরিতে লেখে তা native ভাবে স্ক্যান
করে।
