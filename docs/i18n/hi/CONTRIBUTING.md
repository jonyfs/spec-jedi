<!-- i18n-sync: source=CONTRIBUTING.md@8dc71a4 lang=hi -->
...
- Product skills का नाम `specjedi-*` रखा जाता है — यह naming convention इस repo ने अपनी
  पहली ही skill से अपनाई है (Principle XV)। ऐतिहासिक टिप्पणी: यह project पहले खुद को
  बनाने के लिए vendored `speckit-*` bootstrap tooling का इस्तेमाल करता था, इससे पहले कि
  इसकी अपनी `specjedi-*` pipeline पूरी होती; वह bootstrap चरण feature 048 (2026-07-18)
  के साथ ख़त्म हो गया — इस repo का अपना development अब पूरी तरह `specjedi-*` पर चलता
  है, वही tool जिसे यह ship करता है। पूरे walkthrough के लिए README का "Spec Jedi कैसे
  खुद को बनाता है" section देखें।
