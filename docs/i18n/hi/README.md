<!-- i18n-sync: source=README.md@bf963a8 lang=hi -->
...
[![Skills](https://img.shields.io/badge/specjedi_skills-24_shipped-success)](#आज-आपको-क्या-मिलता-है)
...
चौबीस की संख्या में यह Order है — लड़ाई के लिए नहीं, बल्कि Spec-Driven
...
| `specjedi-quick` ⚡ | छोटे, अच्छी तरह समझे गए बदलावों के लिए lightweight रास्ता — `spec.md`+`research.md`+`plan.md`+`tasks.md` की जगह सिर्फ़ एक `quick.md`, सीधे implementation तक। Quality gates (test-first, `specjedi-govcheck`, केवल PR के ज़रिए) कभी छोटे नहीं होते, केवल planning की औपचारिकता छोटी होती है। किसी भी बड़े, अस्पष्ट, या नई skill वाले काम के लिए मना करती है और `specjedi-specify` की ओर भेज देती है — देखें [कौन सा तरीका अपनाएँ](#कौन-सा-तरीका-अपनाएँ) |
...
(जैसे [#82](https://github.com/jonyfs/spec-jedi/pull/82),
[#84](https://github.com/jonyfs/spec-jedi/pull/84),
[#87](https://github.com/jonyfs/spec-jedi/pull/87)) के पीछे की असली,
बार-बार दोहराई गई प्रक्रिया है — हर एक ने वाकई में यही आठों panels चलाए हैं।
...
3. Claude Code prompt में `/` टाइप करके पुष्टि करें कि skills load हो
   गई हैं। आपको सभी 24 `specjedi-*` product skills और `speckit-*`
...
**repo को clone बिल्कुल नहीं करना चाहते?** `scripts/bootstrap-install.sh`/`.ps1`
(specs/024-bootstrap-installer) आपके लिए एक published GitHub Release लाते हैं
और उसमें bundled installer चलाते हैं — कोई local checkout ज़रूरी नहीं:
...
⚠️ इस project का अपना पहला release अभी तक cut नहीं हुआ है (Principle XI —
release cut करना हमेशा maintainer का जान-बूझकर उठाया गया कदम है, कभी
automatic नहीं), इसलिए ऊपर दी गई one-liner अभी "no release found" रिपोर्ट
करेगी, साथ ही एक git-clone fallback command देगी। यह इसी असली, मौजूदा
स्थिति के विरुद्ध shipped और CI-tested है; जैसे ही कोई release मौजूद
होगी, यह वाकई install करना शुरू कर देगी।

`--harness` optional है — अगर छोड़ दिया जाए, तो installer `claude-code`/
`codex-cli`/`trae` में से यह पता लगाने की कोशिश करता है कि आप कौन सा
coding agent इस्तेमाल कर रहे हैं (पहले से मौजूद project directory, `PATH`
पर मौजूद binary, या पहले से मौजूद global config directory), और अपने-आप
उसके लिए install करता है — सिर्फ तभी पूछता है जब एक से ज़्यादा संभावित
match मिलें। बाक़ी 17 harnesses (जिनके लिए अभी कोई भरोसेमंद filesystem/
PATH detection signal मौजूद नहीं है) को explicitly `--harness` देना
ज़रूरी है। पूरी option list के लिए `./scripts/install.sh --help` (या
`.\scripts\install.ps1 -Help`) चलाएँ, जिसमें `--auto` भी शामिल है।

### समर्थित harnesses

Spec Jedi का constitution
([Principle III](../../../.specify/memory/constitution.md)) इस project
को market के बीस सबसे ज़्यादा इस्तेमाल किए जाने वाले LLM coding
tools/harnesses को support करने के लिए प्रतिबद्ध करता है — इस release के
अनुसार, सभी बीस असली, test किए गए, और CI-proven हैं। चार harnesses native
skills-directory scan इस्तेमाल करते हैं (Claude Code, Codex CLI, Trae,
Antigravity — आख़िरी तीन सिर्फ़ दो physical target directories share
करते हैं, `.agents/skills/` और `.trae/skills/`, साथ ही OpenCode और Warp
उन्हीं paths से बिना किसी अतिरिक्त code के satisfy हो जाते हैं)। बाक़ी
चौदह के पास native skills-directory का कोई concept नहीं है — सिर्फ़ एक
project-root rules file, एक छोटी rules directory, या (Sourcegraph Cody
के लिए) एक custom-commands JSON file है — इसलिए installer एक **bridge**
बनाता है: पूरा `specjedi-*` package हमेशा की तरह canonical
`.claude/skills/` में उतरता है, और एक छोटी adapter file (directory-style
harnesses के लिए, प्रति skill एक file) उस harness के अपने documented
convention का उपयोग करके उसकी ओर इशारा करती है। हर harness के exact
mechanism के पीछे citation के लिए देखें
...
नाम से सूचीबद्ध किए गए हैं, सभी ✅ Supported — किसी भी ऐसे mechanism के
लिए कोई capability claim नहीं जिसे इस project ने वास्तव में build और
test नहीं किया है, Principle XX के hallucination-resistance अनुशासन के
अनुसार।

हर harness की मूल desk-research capability notes के लिए देखें
[`references/harness-capability-notes.md`](../../../references/harness-capability-notes.md),
और इस table के आधार पर लिए गए install-mechanism decisions व citations के
लिए देखें
[`specs/023-full-harness-coverage/research.md`](../../../specs/023-full-harness-coverage/research.md)।
...
बिना किसी छुपाव वाला संस्करण चाहिए — असली advantages, असली मौजूदा
limitations, और competitor-grounded ठोस improvement points? देखें
[`references/honest-assessment.md`](../../../references/honest-assessment.md)।

## Quickstart

आज चौबीस product skills उपलब्ध हैं
...
| बदलाव का आकार | इस्तेमाल करें | परिणाम |
|---|---|---|
| छोटा, अच्छी तरह समझा हुआ — एक typo, एक-file वाला fix, एक tightly-scoped tweak | `specjedi-quick` ⚡ | एक `quick.md`, सीधे shipped code तक |
| कुछ भी बड़ा, अस्पष्ट, एक से ज़्यादा subsystem को छूता हुआ, या नई `specjedi-*` skill | पूरा pipeline (नीचे step 3-11) | `spec.md` → `plan.md` → `tasks.md` → shipped code |

`specjedi-quick` कुछ भी लिखने से पहले ख़ुद पाँच explicit criteria के
विरुद्ध eligibility जाँचती है — अगर आपका request वाकई लगभग एक पेज के
notes में fit नहीं होता, तो यह मना कर देती है और आपको `specjedi-specify`
की ओर redirect कर देती है, बजाय इसके कि उसे ज़बरदस्ती इसी रास्ते से निकाला
जाए। दोनों रास्ते एक जैसे quality gates लागू करते हैं (जहाँ code शामिल है
वहाँ test-first, PR खुलने से पहले `specjedi-govcheck`) — "quick" सिर्फ़
planning की औपचारिकता छोटी करती है, verification को कभी नहीं।
