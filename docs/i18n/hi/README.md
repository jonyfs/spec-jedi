<!-- i18n-sync: source=README.md@2a01f98 lang=hi -->
...
[![Skills](https://img.shields.io/badge/specjedi_skills-30_shipped-success)](#spec-jedi-sdd-को-कैसे-implement-करता-है)
...
Spec-Driven Development (SDD) इसी क्रम को पलट देता है। कोई भी कोड लिखे जाने से
पहले, यह लिख दिया जाता है कि क्या बनाया जा रहा है और क्यों, चार structured,
review-योग्य दस्तावेज़ों के रूप में: `specjedi-constitution` द्वारा लिखा गया
एक **constitution** 📜 (प्रोजेक्ट के गैर-परक्राम्य नियम), `specjedi-specify`
द्वारा लिखा गया एक **specification** 🎯 (क्या, और किसके लिए), `specjedi-plan`
द्वारा लिखा गया एक **plan** 🛠️ (तकनीकी रूप से कैसे), और `specjedi-tasks` द्वारा
लिखा गया एक **task list** ✅ (क्रमबद्ध चरण)। कोड इन्हीं चार artifacts के
*आधार पर* generate होता है, उल्टा नहीं। पूरी explanation, बिना किसी
Spec-Jedi-specific ब्रांडिंग के:
...
Spec Jedi, [spec-kit](https://github.com/github/spec-kit) का एक
**प्रतिस्पर्धी** है ([Principle XV](../../../.specify/memory/constitution.md))
— यह एक `specjedi-*` skill set के रूप में बनाया गया है जिसे कोई project
spec-kit के अपने `speckit-*` commands के साथ, या उनकी जगह, install कर सकता है,
और सभी बीस target coding agents के लिए support मौजूद है (नीचे
[इंस्टॉलेशन](#इंस्टॉलेशन) देखें)। पूरा `specjedi-*` SDD pipeline —
constitution से लेकर convergence तक — काफ़ी समय पहले पूरी तरह ship हो चुका है:
...
मिलाकर तीस skills उपलब्ध हैं, चार disciplines में — पूरा catalog, दोनों
...
### `specjedi-*` बनाम `speckit-*`, आँकड़ों में

एक evidence-based, command-by-command तुलना —
[`specs/044-speckit-parity-audit/PARITY-LEDGER.md`](../../../specs/044-speckit-parity-audit/PARITY-LEDGER.md)
— ने `speckit-*` के सभी 11 pipeline commands को उनके `specjedi-*` समकक्ष के
मुक़ाबले असली वर्णित व्यवहार के आधार पर जाँचा, नाम की समानता के आधार पर नहीं:

- **11 में से 8** पूरी तरह parity में हैं — वही काम, वही inputs/outputs।
- **11 में से 1** (`specjedi-implement` बनाम `speckit-implement`) एक अनुकूल
  विचलन है: `specjedi-implement` को केवल एक feature branch और pull request
  के माध्यम से commit करने की आवश्यकता होती है, कभी सीधे trunk branch पर
  नहीं; `speckit-implement` के अपने instructions में कोई git branch या
  commit discipline बिल्कुल नहीं है।
- **11 में से 2** का कोई `specjedi-*` समकक्ष नहीं है — दोनों पहले से ही हल हो
  चुके हैं, कोई खुला gap नहीं: GitHub-issue task conversion (इस project के
  अपने असली इतिहास में कभी इस्तेमाल नहीं हुआ) और एक persistent "current
  plan" pointer (जिसकी जगह `specjedi-status` के zero-parallel-tracking
  design और Constitution Principle XXI के अपने session-start status
  re-surfacing ने ले ली है)।
- शिप हुई **30 में से 21** `specjedi-*` skills का कोई `speckit-*` समकक्ष
  बिल्कुल नहीं है — `specjedi-catalog-audit`, `specjedi-chain`,
  ...
  `specjedi-skill-review`, `specjedi-status`, `specjedi-tokencheck`, और
  `specjedi-worktree` — असली जोड़ी गई क्षमता है, दोहराई गई pipeline नहीं।
...
> ⚠️ **यह section इस project की अपनी असली development pipeline को क्रिया
> में दिखाता है** — नीचे दिए गए `specjedi-*` commands ठीक वही product
> surface हैं जो ऊपर बताई गई है, Spec Jedi पर ही इस्तेमाल हो रही है। feature
> 048 (2026-07-18) तक, यह project खुद को बनाने के लिए spec-kit के अपने
> vendored `speckit-*` commands का इस्तेमाल करता था (वही "पुराने compiler से
> नया compiler बनाने" वाला pattern जिसे कोई भी प्रतिस्पर्धी अपना replacement
> बनाते समय इस्तेमाल कर सकता है), इससे पहले कि इसकी अपनी `specjedi-*`
> pipeline इसे संभालने लायक़ पूरी तरह तैयार होती। वह bootstrap चरण अब ख़त्म
> हो चुका है — इस migration को पूरा करने वाली पूरी policy के लिए देखें
...
> बनाता है जो franchise के अपने पहचाने जाने वाले visual संकेतों को याद
> दिलाए। तो: story के moments असली हैं, art original है, और शब्द अकेले भी
> अर्थ पूरी तरह पहुँचाते हैं। 🖋️
...
की पहली लड़ाई कभी आख़िरी नहीं होती। `/specjedi-constitution` नियम एक बार
...
नहीं दिया — असल में क्या बनाया जा रहा है, और किसके लिए। `/specjedi-specify`
इसे एक असली `spec.md` में बदलती है; `/specjedi-clarify` उस ambiguity को
...
फिर blueprint सामने आता है। `/specjedi-plan` `plan.md` बन जाता है,
`/specjedi-tasks` इसे एक क्रमबद्ध, dependency-aware `tasks.md` में तोड़ता है
...
धीरे-धीरे, fail होना बंद कर देते हैं। `/specjedi-implement` जहाँ लागू हो वहाँ
...
`claude-code`, `codex-cli`, और `trae` के लिए, installer उस harness की अपनी
project-memory file (`CLAUDE.md`, `AGENTS.md`, या
`.trae/rules/project_rules.md`) को भी बनाता या update करता है, जिसमें
installed skills के नाम बताने वाला एक छोटा, marker-delimited section होता
है — ताकि harness के अपने context को पहले से पता हो कि वे मौजूद हैं, सिर्फ़
skills directory को ही नहीं। अगर वह file पहले से आपकी अपनी content के साथ
मौजूद है, तो आपकी किसी भी चीज़ को छुआ नहीं जाता; section को जोड़ दिया जाता
है और बाद के re-installs पर सिर्फ़ वही section refresh होता है।
...
में से बीस target harnesses के पास एक असली, CI-tested install path है,
diagrams दिखाए जाने से पहले render-verified होते हैं, चार असली releases
ship हो चुकी हैं (`v0.1.0`, `v0.1.1`, `v0.2.0`, `v0.3.0`), और constitution
v1.29.0 पर एक जीवंत, versioned document है जिसमें documented amendment
history है। दूसरा आधा, साफ़ शब्दों में: ज़्यादातर bridge-file harness
install paths असली third-party product के अंदर hands-on session के बजाय
desk research पर टिके हैं (नीचे देखें), और इस project की अपनी localized
documentation अक्सर अपने अंग्रेज़ी source से पीछे रह जाती है —
`scripts/validate.sh` फ़िलहाल सभी 10 translated `README.md` और
`CONTRIBUTING.md` copies को नवीनतम अंग्रेज़ी बदलावों के साथ out of sync के
रूप में flag करता है, एक असली, बार-बार होने वाला gap जिसे इस project ने
अभी तक structurally बंद नहीं किया है। पूरी, बिना filter वाली तस्वीर:
...
[`CONTRIBUTING.md`](./CONTRIBUTING.md) में नए skills के लिए competitive
research requirements, Skill Authoring Standard checklist, और PR खोलने से
पहले चलाने वाले validation steps सहित पूरी process है।
