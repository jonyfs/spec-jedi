<!-- i18n-sync: source=README.md@402bb58 lang=ru -->
...
| `specjedi-diagram` 📊 | Генерирует проверенную рендерингом диаграмму Mermaid (flowchart, sequence или ER — выводится из содержимого) на основе существующего `spec.md`/`plan.md` — всегда дополнение к исходному тексту, никогда не замена |
...
14. Хотите картинку вместо стены прозы? `specjedi-diagram` 📊
    ...
    диаграмму Mermaid — flowchart, sequence или ER, в зависимости от
    того, что требует реальное содержимое — всегда рядом с исходным
