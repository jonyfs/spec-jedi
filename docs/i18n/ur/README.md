<!-- i18n-sync: source=README.md@01f83f5 lang=ur -->
...
| `specjedi-diagram` 📊 | کسی موجودہ `spec.md`/`plan.md` سے render-verified Mermaid diagram تیار کرتی ہے (flowchart، sequence، یا ER — مواد سے اخذ کردہ) — ہمیشہ اصل نثر کی تکمیل، کبھی متبادل نہیں |
...
یہ ابھی ہر harness کے لیے الگ سے verify یا document نہیں کیا گیا۔
...
14. نثر کی دیوار کے بجائے ایک picture چاہیے؟ `specjedi-diagram` 📊
    ...
    ہے — flowchart، sequence، یا ER، جو بھی حقیقی مواد مانگے — ہمیشہ
    source نثر کے ساتھ، کبھی اس کی جگہ نہیں۔
