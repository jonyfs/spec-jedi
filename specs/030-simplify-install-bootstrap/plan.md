...
**Branch**: `030-simplify-install-bootstrap` | **Date**: 2026-07-13 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `specs/030-simplify-install-bootstrap/spec.md`
...
```text
specs/030-simplify-install-bootstrap/
├── plan.md              # This file
